 ...
 * We modified the shellSort method, main, and the specification of the multiplicative factor.
 * 
...
public class ShellSort {
     ...
     * Uses the gap sequence we discussed in class of dividing by 2 and adding one if even.
     * We added an additional parameter m to the shellSort method.
    ...
    public static void shellSort(int[] array, double m) {
        int gap = array.length/2; //  Always divide in half to get first gap
        while (gap >= 1) {
            ...
            if (gap == 1) { //  This portion allows for us to maintain the functionality of the original code.
                ...
                gap = (int) Math.ceil(gapTemp);
                //  Here, we cast the resulting gap to an integer after
    ...
    /**
     * Helper method for shellSort. Does an insertion sort of the
     * subarray at array[first,first+gap, first+gap*2,...]
     */
    ...
    /**
     * The main method contains our investigation code.
     */
